// Interpret expects something in the form a & b
...
pub fn interpret(input_string: &str) -> LogicObject {
...
mod tests {
    ...
    #[test]
    fn test_interpret_a_and_b() {
        let object_a: LogicObject = interpret("a & b");
    ...
    #[test]
    fn test_interpret_apple_and_candy() {
        let object_a: LogicObject = interpret("apple & candy");
    ...
    #[test]
    fn test_interpret_apple_or_candy() {
        let object_a: LogicObject = interpret("apple | candy");
        assert_eq!("apple", object_a.a);
        assert_eq!("candy", object_a.b);
        assert_eq!("|", object_a.operator);
    ...
    #[test]
    fn test_interpret_apple_implies_candy() {
        let object_a: LogicObject = interpret("apple => candy");
        assert_eq!("apple", object_a.a);
        assert_eq!("candy", object_a.b);
        assert_eq!("=>", object_a.operator);
